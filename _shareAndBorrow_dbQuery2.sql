...
INSERT INTO `ShareAndBorrow`.`address` (`id`, `city`, `country`, `flat_number`, `home_number`, `postal_code`, `street`, `user_name`, `voievodyship`) VALUES ('2', 'aCity', 'Polska', 'a1f', 'a1h', '00-999', 'aStreet', 'aaaa','mazowieckie');

INSERT INTO `ShareAndBorrow`.`tool_type` (`id`, `type`) VALUES ('1', 'Elektronarzedzia');
INSERT INTO `ShareAndBorrow`.`tool_type` (`id`, `type`) VALUES ('2', 'Reczne');
INSERT INTO `ShareAndBorrow`.`tool_type` (`id`, `type`) VALUES ('3', 'AGD');
INSERT INTO `ShareAndBorrow`.`tool_type` (`id`, `type`) VALUES ('4', 'RTV');
INSERT INTO `ShareAndBorrow`.`tool_type` (`id`, `type`) VALUES ('5', 'Spalinowe');
